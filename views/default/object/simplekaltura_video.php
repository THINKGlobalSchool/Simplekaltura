...
<br /><br />
<input type="button" onclick="$('#kdp_inst').get(0).playMedia();" value="Play!" />
<input type="button" onclick="$('#kdp_inst').get(0).pauseMedia();" value="Pause!" />
<input type="button" onclick="$('#kdp_inst').get(0).stopMedia();" value="Stop!" />
<a href="http://www.kaltura.org/kdp-apis-about-javascript-integration" title="Learn more about KDP JavaScript APIs and Integration" target="_blank" >Learn more...</a>
