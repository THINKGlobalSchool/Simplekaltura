...
$swf_url            = simplekaltura_get_swf_url($vars['entity'], $uiConfId);
?>
<object id="kaltura_player" name="kaltura_player" type="application/x-shockwave-flash" allowFullScreen="true" allowNetworking="all" allowScriptAccess="always" height="<?php echo $player_height; ?>" width="<?php echo $player_width; ?>" data="<?php echo $swf_url; ?>"> <param name="allowFullScreen" value="true" /> <param name="allowNetworking" value="all" /><param name="allowScriptAccess" value="always" /><param name="wmode" value="transparent" /><param name="bgcolor" value="#000000" /><param name="flashVars" value="&autoPlay=<?php echo $autoPlay; ?>&entryId=<?php echo $entryid; ?>" /><param name="movie" value="<?php echo $swf_url;?>" /></object>